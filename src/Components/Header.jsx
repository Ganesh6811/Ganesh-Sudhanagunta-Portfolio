...
//           <a className="hover:text-[#cf59e6] text-xl font-bold" href="#Home">
//             Home
//           </a>
//           <a className="hover:text-[#cf59e6] text-xl font-bold" href="#AboutMe">
//             About Me
//           </a>
//           <a className="hover:text-[#cf59e6] text-xl font-bold" href="#Skills">
//             Skills
//           </a>
//           <a className="hover:text-[#cf59e6] text-xl font-bold" href="#Projects">
//             Projects
//           </a>
//           <a className="hover:text-[#cf59e6] text-xl font-bold" href="#Contact">
//             Contact
//           </a>
//         </div>
...
//       {/* Mobile Menu */}
//       {isOpen && (
//         <div className="fixed top-[90px] left-[5vw] w-[90vw] rounded-3xl bg-white/80 backdrop-blur-[20px] py-6 px-10 flex flex-col gap-6 z-[99] md:hidden shadow-xl">
//           <a className="hover:text-[#cf59e6] text-lg font-bold" href="#Home" onClick={toggleMenu}>
//             Home
//           </a>
//           <a className="hover:text-[#cf59e6] text-lg font-bold" href="#AboutMe" onClick={toggleMenu}>
//             About Me
//           </a>
//           <a className="hover:text-[#cf59e6] text-lg font-bold" href="#Skills" onClick={toggleMenu}>
//             Skills
//           </a>
//           <a className="hover:text-[#cf59e6] text-lg font-bold" href="#Projects" onClick={toggleMenu}>
//             Projects
//           </a>
//           <a className="hover:text-[#cf59e6] text-lg font-bold" href="#Contact" onClick={toggleMenu}>
//             Contact
//           </a>
//         </div>
//       )}
